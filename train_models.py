...
def LSTM_model_build(units, x_train, y_train, dense):
...
def LSTM_forecast_price(df, n_lookback, n_forecast, feature, dt_freq):
    length = len(df)
    data = df
...
def RNN_forecast_price(df, n_lookback, n_forecast, feature, dt_freq):
    length = len(df)
    data = df
...
def XGBoost_forecast_price(df, n_lookback, n_forecast, feature, dt_freq):
    length = len(df)
    data = df
